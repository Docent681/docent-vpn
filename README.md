...
# Docent-VPN - Веб-интерфейс для управления своим VPN-сервером
 ...
 [Требования](##Требования) • [Установка](##Установка) • [Использование](##Веб-интерфейс)
...
> [!Важно]
> Крайне желательно, что вы не выполняете все последующие действия непосредственно от **root пользователя**, а создали пользователя с правами администратора. На **debian-based** дистрибутивах это можно сделать следующими командами:
...
Если вы используете **Ubuntu Server**, то установить все требуемые программы можно через пакетный менеджер apt:
...
## Веб-интерфейс
![Панель-администратора](https://github.com/Docent681/docent-vpn/screenshots/admin_dashboard.png)

![Панель-пользователя](https://github.com/Docent681/docent-vpn/screenshots/user_dashboard.png)
